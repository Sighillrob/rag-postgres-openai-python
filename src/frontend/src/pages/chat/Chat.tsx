                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Excelsior Learn</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Here are some Examples to Try</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What is our Overtime Policy?)"
                            disabled={isLoading}
